...
bool CComboUI::HotItem(int iIndex, bool bHot)
{
	return true;
}

bool CComboUI::ClickItem(int iIndex, bool bTakeFocus)
{
	return true;
}
bool CComboUI::DBClickItem(int iIndex, bool bTakeFocus)
{
	return true;
}
...
LPCTSTR CComboUI::GetItemAlternateBkImage() const
{
    return m_ListInfo.sAlternateBkImage;
}

void CComboUI::SetItemAlternateBkImage(LPCTSTR pStrImage)
{
...
void CComboUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
    ...
    else if( _tcscmp(pstrName, _T("itemalternatebkimage")) == 0 ) SetItemAlternateBkImage(pstrValue);
