...
namespace DuiLib
{
	...
	public:
		...
		void SetSelectedHotTextColor(DWORD dwTextColor);
		DWORD GetSelectedHotTextColor();
		...
		LPCTSTR GetSelectedHotForeImage();
		void SetSelectedHotForeImage(LPCTSTR pStrImage);
