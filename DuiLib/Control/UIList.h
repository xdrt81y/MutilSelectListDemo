...
public:
    ...
    virtual bool HotItem(int iIndex, bool bHot = true) = 0;
    virtual bool ClickItem(int iIndex, bool bTakeFocus = false) = 0;
	virtual bool DBClickItem(int iIndex, bool bTakeFocus = false) = 0;//@xdrt81y@20140125
    virtual bool SelectItem(int iIndex, bool bTakeFocus = false) = 0;
	virtual bool SelectRange(int iIndex, bool bTakeFocus = false) = 0;//@xdrt81y@20140218
...
public:
    ...
    bool HotItem(int iIndex, bool bHot = true);
    bool ClickItem(int iIndex, bool bTakeFocus = false);
	bool DBClickItem(int iIndex, bool bTakeFocus = false);//@xdrt81y@20140125
    ...
    void SetAlternateBkImage(LPCTSTR pStrImage);
    ...
    LPCTSTR GetItemAlternateBkImage() const;
